...
const AdBanner: React.FC = () => {
    ...
    useEffect(() => {
        // Ensure the script is injected only once per component instance
        if (adContainerRef.current && !scriptInjected.current) {
            const script = document.createElement('script');
            script.setAttribute('data-cfasync', 'false');
            
            // This complex, obfuscated script is provided by the ad network.
            // Injecting it here ensures the ad is placed correctly within this component's container.
            ...
            `;
            script.innerHTML = adScriptContent.replace(/\s+/g, ' ').trim();
    ...
    return (
        <div 
            ref={adContainerRef}
            className="w-[300px] h-[100px] mx-auto overflow-hidden"
